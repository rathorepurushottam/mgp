...
export const CHAMPTHEME = 'CHAMPTHEME';
  ...
  switch (color) {
    ...
    case BROWNYELLOW:
      ...
      case BORDERPINK:
        ...
        break;
        case BOTTOMBLUE:
        style['color'] = colors.bottomBlue;
        break;
        case CHAMPTHEME:
        style['color'] = colors.champTheme;
        break;
        case MYGREEN:
