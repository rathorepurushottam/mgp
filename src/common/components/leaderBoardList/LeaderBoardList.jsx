...
const LeaderBoardList = ({
  ...
  let url = `${BASE_URL}leader-board?limit=${limit}&skip=${skip}&matchid=${matchId}&contest_category_id=${id}&user_id=${userData?._id}`;
  let urlTwo = `${BASE_URL}mainleaderboard?limit=10&skip=0&contest_category_id=${id}&matchid=${matchId}&user_id=${userData?._id}`;
  useEffect(() => {
    if (matchId && id) {
