...
const ContestCard = ({ details, totalTeamCount }) => {
  ...
  const onJoinContest = async () => {
    ...
    //   toastAlert.showToastError('Your aadhaar is not Verified ')
    ...
    <Pressable style={styles.container} onPress={onClickContest}>
      <View style={styles.topContainer}>
        ...
        <View style={styles.progressBar}>
          <LinearGradient
            style={{ width: `90%`, height: '100%', borderRadius: 4 }}
            start={{ x: 0, y: 0 }}
            colors={[
              "#5389C4",
              "#7F3291",
      ...
      <View style={styles.bottomContainer}>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <View style={styles.commonViewStyle}>
            <FastImage tintColor={'#5389C4'} source={GLORY} style={styles.gloryIcon} />
            <AppText
              type={TEN}
              color={WHITE}
          ...
          <View style={styles.commonViewStyle}>
            <FastImage tintColor={'#5389C4'} source={WINNER} style={styles.gloryIcon} />
            <AppText
              type={TEN}
              color={WHITE}
              weight={POPPINS_SEMI_BOLD}
  ...
  {/* {
    console.log(selectTeam,"selecttemasss")
  } */}
  <Confirmation
