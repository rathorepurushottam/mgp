...
import { Dimensions, ImageBackground, Pressable, Share, StyleSheet, View, TouchableOpacity } from 'react-native';
...
//       link: `https://mychamp11.page.link/eNh4?teamId=${teamid}&userId=${userId}&matchID=${matchId}`,
//       domainUriPrefix: 'https://mychamp11.page.link',
//       android: {
//         packageName: 'com.mychamp11'
//       },
//       navigation: {
          ...
          <View style={styles.top}>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              {tab !== 'Completed' && tab !== 'Live' && (
                <TouchableOpacity style={{ padding: 5 }} onPress={onEdit}>
                  <FastImage source={PENCIL} style={styles.icon} />
                </TouchableOpacity>
              )}
              {tab !== 'Completed' && tab !== 'Live' && (
                <TouchableOpacity style={{ padding: 5 }} onPress={onCloneTeam}>
