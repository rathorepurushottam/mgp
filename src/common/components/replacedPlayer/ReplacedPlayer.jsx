...
import { AppText, BLUE, EIGHT, GREEN, POPPINS_BOLD, POPPINS_SEMI_BOLD, RED, TEN, WHITE } from "../../../common/appText/AppText";
...
const ReplacedPlayer = ({ replacedPlayers, notReplacedSubstitutes, refRBSheetReplaced }) => {
    return (
        <View>
            <TouchableOpacity
            ...
            {notReplacedSubstitutes?.map((item) => {
                return (
                    <LinearGradient
                        start={{ x: 0, y: 0 }}
                        end={{ x: 1, y: 0 }}
