...
import { Image, ImageBackground, Platform, RefreshControl, ScrollView, StatusBar, TouchableOpacity, View } from "react-native";
AppText
...
import CommonHeader from "../matchCard/commonHeader/CommonHeader";
import { AppText,BLACK, FORTEEN, POPPINS_MEDIUM, POPPINS_SEMI_BOLD, RBBACKGROUND, SIXTEEN, TEN } from "../../../common/appText/AppText";
        ...
        <View
          ...
          <View style={styles.selectSubConatiner}>
            {NewData?.map(value => {
              ...
              return (
                <TouchableOpacity onPress={() => onSelect(value, item)}>
                  <FastImage
    ...
    <AppSafeAreaView hidden={false}>
      ...
      <CommonImageBackground common>
        ...
        <View style={styles.playerHeadingBar}>
          ...
          <TouchableOpacity style={styles.filerAvgContainer}
