        ...
        <Pressable
          ...
          <View style={styles.matchImage}>
            <View>
              ...
              <View style={{borderWidth: 0.5, borderColor: '#282159', position: "absolute", top: 30, width: "100%", alignSelf: "center"}}></View>
              {details?.line_up_out && (
                <View
                  style={{
                    flexDirection: 'row',
            ...
            <View
              style={[
                ...
                {marginTop: details?.line_up_out ? 0 : 30},
              ]}>
              <View
                style={{
                  width: '33.33%',
            ...
            <View style={{width: '100%', height: 30,backgroundColor: "#040529"}}>
