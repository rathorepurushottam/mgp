...
import { diceLudoImage, ludoIMageProfile, rummyImageIcon } from '../../helper/Image'
  ...
  return (
    <LinearGradient colors={["#01025C", '#121269','#170551']} style={styles.container}>
        ...
        <View style={styles.ludoImageWrapper}>
            <FastImage source={rummyImageIcon} style={styles.ludoImage} resizeMode='stretch' />
